...
class SbisRuPage:
    ...
    def go_to_contacts(self):
        contacts1_link = self.driver.find_element(By.CSS_SELECTOR,
    ...
    def download_local_versions(self):
        ...
        object_to_download_link = self.driver.find_element(By.CSS_SELECTOR,
                                                           'a.sbis_ru-DownloadNew-loadLink__link.js-link[href="https://update.sbis.ru/Sbis3Plugin/master/win32/sbisplugin-setup-web.exe"]')
